...
- [ ] **DEP-P1-01B** Create and push a new scoped release artifact containing only DEP-P0-02/DEP-P1-01A source, template, tests and workflow evidence, after explicit approval of the exact staged paths. Re-verify a clean isolated worktree at the resulting commit. No deployment under this item.
