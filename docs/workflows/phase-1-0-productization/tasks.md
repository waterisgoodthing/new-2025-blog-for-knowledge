...
- [ ] **DEP-P1-01** Prepare the approved release artifact in an isolated clean worktree after separate user approval for the exact staged files and commit. Push remains separately approved.
